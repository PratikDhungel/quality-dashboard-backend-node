...
exports.addNewUserToDB = (req) => {
  return new Promise((resolve, reject) => {
    let query = `INSERTO INTO users (email, first_name, last_name, phone_number, street_name, city, district, province, is_admin, is_verified, verified_on, account_status, last_activity, is_deleted)
